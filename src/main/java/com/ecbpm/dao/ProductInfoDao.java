...
import com.ecbpm.dao.provider.ProductInfoDynaSqlProvider;
...
public interface ProductInfoDao {
    ...
    @Results({@Result(id = true, column = "id", property = "id"), @Result(column = "code", property = "code"),
            ...
            @Result(column = "tid", property = "type", one = @One(select = "com.ecbpm.dao.TypeDao.selectById", fetchType = FetchType.EAGER))})
