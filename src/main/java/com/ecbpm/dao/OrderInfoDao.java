...
import com.ecbpm.dao.provider.OrderInfoDynaSqlProvider;
...
public interface OrderInfoDao {
    @Results({@Result(column = "uid", property = "ui", one = @One(select = "com.ecbpm.dao.UserInfoDao.getUserInfoById", fetchType = FetchType.EAGER))})
    ...
    @Results({@Result(column = "pid", property = "pi", one = @One(select = "com.ecbpm.dao.ProductInfoDao.getProductInfoById", fetchType = FetchType.EAGER))})
